...
export const ThemeToken = {
  ...
  durationVeryShort: 'var(--durationVeryShort)',
  durationShort: 'var(--durationShort)',
  durationMedium: 'var(--durationMedium)',
  durationLong: 'var(--durationLong)',
  durationVeryLong: 'var(--durationVeryLong)',
  durationExtraLong: 'var(--durationExtraLong)',
