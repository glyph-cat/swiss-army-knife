...
import { FaceLandmarker, NormalizedLandmark, PoseLandmarker } from '@mediapipe/tasks-vision'
import {
  Billboard,
  GizmoHelper,
  GizmoViewport,
...
export function convertConnection(connections: Array<Connection>): Array<[start: number, end: number]> {
...
const SCALE_FACTOR_X = 1.5
const SCALE_FACTOR_Y = -1
const SCALE_FACTOR_Z = 1

export interface MeshVisualizerProps {
...
export function MeshVisualizer({
  ...
  const offsettedLandmarks: Nullable<Array<NormalizedLandmark>> = (() => {
