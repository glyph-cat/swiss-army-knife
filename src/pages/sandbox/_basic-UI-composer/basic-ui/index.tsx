...
import { ForwardedRef, forwardRef, JSX, useCallback } from 'react'
import { CheckboxProps, ICheckbox, ICheckboxComponent } from './abstractions/public'
...
export class BasicUIComposer {
   ...
   * @internal
   */
  private readonly M$components: Readonly<{
  ...
  createCheckboxComponent(key: string): ICheckboxComponent {
    ...
    const { Input, View } = this.M$components
