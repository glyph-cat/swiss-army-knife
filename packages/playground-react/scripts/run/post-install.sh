...
if [ -d ../react/lib ]; then
  mkdir -p ./node_modules/@glyph-cat/swiss-army-knife-react
  cp -rf ../react/lib ./node_modules/@glyph-cat/swiss-army-knife-react
  cp ../react/package.json ./node_modules/@glyph-cat/swiss-army-knife-react
  cp ../react/yarn.lock ./node_modules/@glyph-cat/swiss-army-knife-react
fi
