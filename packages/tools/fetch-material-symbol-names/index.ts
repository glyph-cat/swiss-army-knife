...
async function fetchMaterialSymbolNames(): Promise<void> {
  ...
  const fileBody = [
    ...
    '// This file was automatically generated by running `pnpm-rush tsx bot:muicon`.',
    '// To learn more, refer to `tools/fetch-material-symbol-names`',
    '', // (Empty line)
