...
- Moved from `@glyph-cat/swiss-army-knife` to `@glyph-cat/foundation` (new package): `BuildType`, `Encoding`, `ShortBool`, `KeyValuePair`, `StrictPropertyKey`, `PlainRecord`, `StrictRecord`, `PartialStringRecord`, `NumericRecord`, `StringRecord`, `PartialRecord`, `ReadonlyOrWritableArray`, `TypedFunction`, `CleanupFunction`, `LenientString`, `NumericValues3`, `NumericValues4`, `Awaitable`, `Voidable`, `PossiblyUndefined`, `Awaited`, `AwaitedReturnType`, `Falsable`, `IDisposable`, `RefObject`, `QRErrorCorrectionLevel`.
