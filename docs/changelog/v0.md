...
- Removed: `Nullable`
- The following functions have been split into `@glyph-cat/type-checking`: `isBoolean`, `isFunction`, `isNaN`, `isNull`, `isNullOrEmpty`, `isNullOrWhitespace`, `isNullOrUndefined`, `isNumber`, `isNumberOrNaN`, `isObject`, `isObjectOrNull`, `isString`, `isSymbol`, `isThenable`, `isUndefined`, `isUndefinedOrNull`
